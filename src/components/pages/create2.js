...
class Createpage extends Component {
  ...
  handleValidation() {
    ...
    if (method === 'buy_now' && (!fields["item_price"] || fields["item_price"] <= 0)) {
      formIsValid = false;
      errors["item_price"] = "This field is required.";
    }

    if (method !== 'buy_now' && (!fields["priceover"] || fields["priceover"] <= 0)) {
      formIsValid = false;
      errors["priceover"] = "This field is required.";
    }

    if (method === 'on_auction' && this.state.auctionInterval < 0 ) 
    {
      formIsValid = false;
      errors["deadline"] = "Please select correct date and time.";
    }
  ...
  handlelChangeDeadline = (value) => {
    let dl = Date.parse(value) - Date.now();
    if(dl > 1000 * 60)    // bigger than 60s 
    {
      this.setState({ deadline : value })
      this.setState({ auctionInterval : dl });
    }
    else {
      this.setState({ deadline : (new Date()) });
    }
  }
  ...
  handleSubmit = async (e) => {
    ...
    if (!currentUser || (currentUser && currentUser.role && currentUser.role.name !== 'Creator')) {
    ...
    if (this.handleValidation()) {
      ...
      const param = {
        ...
        end_date:  this.state.auctionInterval,
      ...
      const result = await createSingleNft(param);
      if (result.success) {
  ...
  checkAuctionStatus = async (flag) => {
      this.setState({isEnded: flag});
  }
  ...
  render() {
    ...
    if (!currentUser || (currentUser.role && currentUser.role.name !== 'Creator')) {
          ...
          <div className="row">
              ...
              <form id="form-create-item" className="form-border" onSubmit={this.handleSubmit}>
                <div className="field-set">
                  ...
                  <div className="d-create-file">
                    ...
                    {this.state.selected_file && (<p>{this.state.selected_file.name}</p>)}
                  ...
                  <div className="de_tab tab_methods">
                    ...
                    <div className="de_tab_content pt-3">
                      <div id="tab_opt_1">
                        ...
                        <div className="row">
                          <div className="col-md-8">
                            <input type="number" name="item_price" id="item_price" onChange={this.handleChange} className="form-control mb-2" placeholder="enter price for one item" step="0.001" />
                      ...
                      <div id="tab_opt_2" className='hide'>
                        ...
                        <div className="row">
                          <div className="col-md-8">
                            <input type="number" name="priceover" id="priceover" onChange={this.handleChange} className="form-control mb-2" placeholder="enter start price" step="0.001" />
                          ...
                          <div className="col-md-12">
                            ...
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <DateTimePicker
                                ...
                                onChange={(newValue) => {
                                  this.handlelChangeDeadline(newValue);
                                }}
                  ...
                  <h5>Royalties</h5>
                  <input type="number" name="item_royalties" id="item_royalties" onChange={this.handleChange} className="form-control mb-2" placeholder="suggested: 0, 10%, 20%, 30%. Maximum is 70%" step="1" />
                  <span style={{ color: "red" }}>{this.state.errors["item_royalties"]}</span>

                  <div className="spacer-10"></div>

                  <button type="submit" id="submit" className="btn-main mb-2">Mint Item</button>
                </div>
              </form>
            ...
            <div className="col-lg-3 col-sm-6 col-xs-12">
              ...
              <div className="nft__item m-0">
                {this.state.method === "on_auction" && this.state.deadline && (
                  <div className="de_countdown">
                    <Clock deadline={this.state.auctionInterval} nftId={null} checkAuctionStatus={this.checkAuctionStatus}/>
                  </div>
                )}
                ...
                <div className="nft__item_info">
                  ...
                  {this.state.method !== 'buy_now' && this.state.fields.priceover && (
                    <div className="nft__item_price">
