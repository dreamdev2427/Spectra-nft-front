...
const hotCollections = hotCollectionsState.data ? hotCollectionsState.data[0] : null;
...
return (
  <div>
  <GlobalStyles/>
    { hotCollections && hotCollections.author &&  hotCollections.author.banner &&
        ...
        <div className="col-md-12">
          <div className="d_profile">
            <div className="profile_avatar">
                { hotCollections && hotCollections.author &&  hotCollections.author.avatar &&
                ...
                <div className="profile_name">
                  <h4>
                      ...
                      { hotCollections && hotCollections.author &&  hotCollections.author.wallet &&
    ...
    <section className='container no-top'>
        ...
        {openMenu && (  
          <div id='zero1' className='onStep fadeIn'>
            <ColumnNewRedux shuffle showLoadMore={false} authorId={hotCollections && hotCollections.author ? hotCollections.author.id : 1} />
          </div>
        )}
        {openMenu1 && ( 
